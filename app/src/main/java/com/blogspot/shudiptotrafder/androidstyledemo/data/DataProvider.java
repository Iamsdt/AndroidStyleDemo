package com.blogspot.shudiptotrafder.androidstyledemo.data;
...
import static com.blogspot.shudiptotrafder.androidstyledemo.data.MainWordDBContract.Entry.TABLE_NAME;
import static com.blogspot.shudiptotrafder.androidstyledemo.data.MainWordDBContract.PATH_TASKS;
...
public class DataProvider extends ContentProvider {
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (match) {
            case TASKS:
                // directory
                return "vnd.android.cursor.dir" + "/" + MainWordDBContract.AUTHORITY + "/" + PATH_TASKS;
            case TASK_WITH_ID:
                // single item type
                return "vnd.android.cursor.item" + "/" + MainWordDBContract.AUTHORITY + "/" + PATH_TASKS;
            default:
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case TASK_WITH_ID:
                ...
                deleteNumber = db.delete(TABLE_NAME, mSelection, mSelectionArg);
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case TASK_WITH_ID:
                ...
                updateNumber = db.update(TABLE_NAME, values, mSelection, mSelectionArg);
